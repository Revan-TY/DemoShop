...
public class ReadExcelUtility {
	...
	public static int getLastCellNumber(String registerExcelPath, String sheeName, int row) throws IOException {
		fis = new FileInputStream(registerExcelPath);
		return new XSSFWorkbook(fis).getSheet(sheeName).getRow(row).getLastCellNum();
	}
